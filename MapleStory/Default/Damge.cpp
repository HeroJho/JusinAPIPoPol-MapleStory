...
void CDamge::Init(int _iStart, int _iEnd , int _iDamageSkin)
{
	m_iStart = _iStart;
	m_iEnd = _iEnd;
...
void CDamge::Late_Update(void)
{

	// Move_Frame();
}

void CDamge::Render(HDC hDC)
{
	int iShfX = 0;
