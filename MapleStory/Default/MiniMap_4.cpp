...
void CMiniMap_4::Initialize(void)
{
	m_sTag = "MiniMap_2";
...
void CMiniMap_4::Late_Update(void)
{

}

void CMiniMap_4::Render(HDC hDC)
{

	HDC		hMemDCFrame = CBmpMgr::Get_Instance()->Find_Image(L"MiniMap_4");
	...
	float fDisX = fMapX / 260;
	float fDisY = fMapY / 124;
...
void CMiniMap_4::ColRender(HDC hDC)
{
	Rectangle(hDC,
		int(m_tRect.left),
		int(m_tRect.top),
