...
void CMiniMap_2::Initialize(void)
{
	m_sTag = "MiniMap_2";
...
void CMiniMap_2::Late_Update(void)
{

}

void CMiniMap_2::Render(HDC hDC)
{

	HDC		hMemDCFrame = CBmpMgr::Get_Instance()->Find_Image(L"MiniMap_2");
...
void CMiniMap_2::ColRender(HDC hDC)
{
	Rectangle(hDC,
		int(m_tRect.left),
		int(m_tRect.top),
