...
void CMiniMap_6::Initialize(void)
{
	m_sTag = "MiniMap_2";
...
void CMiniMap_6::Late_Update(void)
{

}

void CMiniMap_6::Render(HDC hDC)
{

	HDC		hMemDCFrame = CBmpMgr::Get_Instance()->Find_Image(L"MiniMap_6");
...
void CMiniMap_6::ColRender(HDC hDC)
{
	Rectangle(hDC,
		int(m_tRect.left),
		int(m_tRect.top),
